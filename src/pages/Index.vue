	...
	<Layout>
		<div class="pt-8 md:pt-16">
			<div class="flex flex-col items-center">
				...
				<div class="py-4">
					<code class="block px-4 py-1 select-all bg-border text-on-background"
				...
				<div class="flex justify-center mt-8">
					<g-link
						to="/docs/"
						class="flex items-center px-6 py-4 ml-auto text-2xl font-bold leading-none text-white border rounded-lg shadow-lg bg-brand border-brand transition-all duration-200 ease-out transform hover:shadow-xl hover:-translate-y-1"
					>
						Get started
				...
				<p class="mt-8 text-center">
					...
					<span class="border-b border-dashed border-brand text-brand"
			...
			<div
				class="pt-8 mx-auto mt-8 border-t md:mt-16 md:pt-16 border-top border-border max-w-screen-sm"
			></div>
